package net.garcia.benjamin.djroux_roux.BasicPlayer;
...
public class BasicPlayer implements BasicController, Runnable {
     ...
     */
    public BasicPlayer(Balance ins) {
        m_dataSource = null;
     ...
     * Ressources.<br> Player Status == PLAYING => Audio stream data sent to
     * Audio line.<br> Player Status == PAUSED => Waiting for another status.
     */
    public void run() {
